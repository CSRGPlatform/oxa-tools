...
LMS_URL=aiacloudstreet.$BASE_URL
CMS_URL=aiacloudstreet-studio.$BASE_URL
PREVIEW_URL=aiacloudstreet-preview.$BASE_URL
...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/CSRGPlatform/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/CSRGPlatform/edx-platform.git
PLATFORM_VERSION=oxa/master.fic
THEME_REPO=https://github.com/CSRGPlatform/edx-theme.git
